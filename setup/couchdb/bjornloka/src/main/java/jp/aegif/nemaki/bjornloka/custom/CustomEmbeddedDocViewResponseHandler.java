...
public class CustomEmbeddedDocViewResponseHandler<T> extends StdResponseHandler<List<T>> {
	...
	public CustomEmbeddedDocViewResponseHandler(Class<T> docType, ObjectMapper om, boolean ignoreNotFound) {
		Assert.notNull(om, "ObjectMapper may not be null");
		Assert.notNull(docType, "docType may not be null");
		parser = new CustomQueryResultParser<T>(docType, om);
