...
public interface ExceptionService {
	...
	// ObjectNotFound & PermissionDenied exception are handled by calling getObject
	// method
	...
	<T> void constraintPropertyValue(String repositoryId, TypeDefinition typeDefinition, Properties properties,
			String objectId);
