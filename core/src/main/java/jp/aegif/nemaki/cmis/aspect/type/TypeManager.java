...
public interface TypeManager {
	...
	/**
	 * Get a property definition specified with its query name and under specified
	 * type
	 * 
	 * @param repositoryId   TODO
	 ...
	 * 
	 * @param queryName
	 * @return PropertyDefinition with only core attribute(Id, QueryName,
	 *         ProeprtyType, Cardinality)
	 */
	 ...
	 * 
	 * @param typeId id of the type definition
	 ...
	 * 
	 * @param repositoryId  TODO
	 * @param typeQueryName query name of the type definition
	 * 
	...
	/**
	 * return a list of all types known in this repository Note: This method is not
	 * needed for the query parser.
	 * 
	 * @param repositoryId TODO
	 * 
	 ...
	 * folder, policy and relationship Note: This method is not needed for the query
	 * parser.
	 * 
	 * @param repositoryId TODO
	 * 
	 ...
	 * 
	 * @param repositoryId   TODO
	 * @param typeDefinition type definition containing query name
	 * @param propQueryName  query name of property
	 * 
	 * @return property id of property or null if not found
	 */
	String getPropertyIdForQueryName(String repositoryId, TypeDefinition typeDefinition, String propQueryName);

	/**
	 * Add a type to the type system. Add all properties from inherited types, add
	 * type to children of parent types. Note: This method is not needed for the
	 * query parser.
	 * 
	 * @param repositoryId           TODO
	 * @param typeDefinition         new type to add
	 * @param addInheritedProperties add properties from supertype to type
	 *                               definition
	 */
	void addTypeDefinition(String repositoryId, TypeDefinition typeDefinition, boolean addInheritedProperties);

	/**
	 * Modify an existing type definition. Note: This method is not needed for the
	 * query parser.
	 * 
	 * @param repositoryId   TODO
	 * @param typeDefinition type to be modified
	 */
	void updateTypeDefinition(String repositoryId, TypeDefinition typeDefinition);

	/**
	 * Delete a type from the type system. Delete will succeed only if type is not
	 * in use. Otherwise an exception is thrown. Note: This method is not needed for
	 * the query parser.
	 * 
	 * @param repositoryId TODO
	 * @param typeId       id of type to be deleted
	 */
