...
public abstract class AbstractCmisServiceWrapper implements NemakiCmisServiceWrapper {
	...
	private static final Log log = LogFactory.getLog(AbstractCmisServiceWrapper.class);

	private ThreadLocal<NemakiCmisService> threadLocalService = new ThreadLocal<>();
	...
	/**
	 * Sets the call context and propagates it down to the next service wrapper or
	 * service if it implements the {@link CallContextAwareCmisService} interface.
	 */
	@Override
	public void setCallContext(CallContext callContext) {
		getWrappedService().setCallContext(callContext);
	}
	...
	public CallContext getCallContext() {
		return getWrappedService().getCallContext();
	}
