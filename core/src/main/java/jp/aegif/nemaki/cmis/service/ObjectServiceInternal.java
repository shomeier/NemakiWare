...
public interface ObjectServiceInternal {
	 ...
	 */
	public abstract void deleteObjectInternal(@LogParam("callContext") CallContext callContext,
			@LogParam("repositoryId") String repositoryId, @LogParam("content") Content content,
			@LogParam("allVersions") Boolean allVersions, @LogParam("deleteWithParent") Boolean deleteWithParent);
